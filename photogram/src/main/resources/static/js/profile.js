...
function profileImageUpload(pageUserId, principalId) {
	...
	$("#userProfileImageInput").on("change", (e) => {
		...
		$.ajax({
			...
			data: formData,
			contentType: false,	//ajax로 사진 전송하려면 필수 : x-www-form-urlencoded로 파싱되는 것을 방지
			processData: false,	//필수 : contentType을 false로 했을 때 QueryString 자동 설정됨
